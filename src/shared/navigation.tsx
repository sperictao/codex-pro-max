...
import type { SettingsSection, View } from "@/shared/store";

// 壳导航的唯一事实来源：顶栏、设置侧栏与命令面板都从这里取，避免三处各写一份。
// Skill 按钮在旧 UI 无 data-i18n（恒为英文），labelKey 为 null 表示不查词典。
export const NAV_ITEMS: { view: View; labelKey: string | null }[] = [
...
export const SETTINGS_SECTIONS: { id: SettingsSection; labelKey: string; icon: ReactNode }[] = [
  {
    id: "general",
    labelKey: "General",
    icon: (
